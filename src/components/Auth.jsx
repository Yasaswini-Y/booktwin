...
export default function Auth({ onLoginSuccess }) {
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-64px)] justify-center p-6 animate-in fade-in duration-500">
      ...
      <div className="bg-white/80 backdrop-blur-sm p-6 rounded-3xl border border-leather/10 shadow-xl relative overflow-hidden">
        {/* Toggle tabs */}
